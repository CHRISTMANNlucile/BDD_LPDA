...
CREATE TABLE `l82_cli_cookie_scan_categories` (
  ...
  `cli_cookie_category_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `l82_mclean_refs` (
  ...
  `mediaUrl` tinytext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `l82_mclean_scan` (
  ...
  `path` tinytext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `l82_rcb_presets` (
  ...
  `description` tinytext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `logoFile` tinytext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  ...
  `other_meta` text COLLATE utf8mb4_unicode_520_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
--
-- Structure de la table `l82_yoast_indexable`
--

CREATE TABLE `l82_yoast_indexable` (
...
--
-- Structure de la table `l82_yoast_indexable_hierarchy`
--

CREATE TABLE `l82_yoast_indexable_hierarchy` (
...
--
-- Structure de la table `l82_yoast_migrations`
--

CREATE TABLE `l82_yoast_migrations` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `l82_yoast_primary_term`
--

CREATE TABLE `l82_yoast_primary_term` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `l82_yoast_seo_links`
--

CREATE TABLE `l82_yoast_seo_links` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
ALTER TABLE `l82_rcb_presets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `identifier` (`identifier`(121),`context`,`type`);
...
ALTER TABLE `l82_rcb_stats`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `dayGroup` (`context`(191),`day`,`term_id`,`accepted`);
...
--
-- Index pour la table `l82_yoast_indexable`
--
ALTER TABLE `l82_yoast_indexable`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `l82_yoast_indexable_hierarchy`
--
ALTER TABLE `l82_yoast_indexable_hierarchy`
...
--
-- Index pour la table `l82_yoast_migrations`
--
ALTER TABLE `l82_yoast_migrations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `wp_yoast_migrations_version` (`version`);

--
-- Index pour la table `l82_yoast_primary_term`
--
ALTER TABLE `l82_yoast_primary_term`
  ADD PRIMARY KEY (`id`),
  ADD KEY `post_taxonomy` (`post_id`,`taxonomy`),
  ADD KEY `post_term` (`post_id`,`term_id`);

--
-- Index pour la table `l82_yoast_seo_links`
--
ALTER TABLE `l82_yoast_seo_links`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `l82_cli_cookie_scan`
--
ALTER TABLE `l82_cli_cookie_scan`
  MODIFY `id_cli_cookie_scan` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `l82_cli_cookie_scan_categories`
--
ALTER TABLE `l82_cli_cookie_scan_categories`
...
--
-- AUTO_INCREMENT pour la table `l82_commentmeta`
--
ALTER TABLE `l82_commentmeta`
...
--
-- AUTO_INCREMENT pour la table `l82_links`
--
ALTER TABLE `l82_links`
...
--
-- AUTO_INCREMENT pour la table `l82_nextend2_image_storage`
--
ALTER TABLE `l82_nextend2_image_storage`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `l82_nextend2_smartslider3_sliders`
--
ALTER TABLE `l82_nextend2_smartslider3_sliders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `l82_wc_admin_note_actions`
--
ALTER TABLE `l82_wc_admin_note_actions`
  MODIFY `action_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `l82_yoast_indexable`
--
ALTER TABLE `l82_yoast_indexable`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `l82_yoast_migrations`
--
ALTER TABLE `l82_yoast_migrations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `l82_yoast_primary_term`
--
ALTER TABLE `l82_yoast_primary_term`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `l82_yoast_seo_links`
--
ALTER TABLE `l82_yoast_seo_links`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Contraintes pour la table `l82_cli_cookie_scan_cookies`
--
ALTER TABLE `l82_cli_cookie_scan_cookies`
  ADD CONSTRAINT `l82_cli_cookie_scan_cookies_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `l82_cli_cookie_scan_categories` (`id_cli_cookie_category`),
  ADD CONSTRAINT `l82_cli_cookie_scan_cookies_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `l82_cli_cookie_scan_categories` (`id_cli_cookie_category`),
  ADD CONSTRAINT `l82_cli_cookie_scan_cookies_ibfk_3` FOREIGN KEY (`category_id`) REFERENCES `l82_cli_cookie_scan_categories` (`id_cli_cookie_category`),
  ADD CONSTRAINT `l82_cli_cookie_scan_cookies_ibfk_4` FOREIGN KEY (`category_id`) REFERENCES `l82_cli_cookie_scan_categories` (`id_cli_cookie_category`),
  ADD CONSTRAINT `l82_cli_cookie_scan_cookies_ibfk_5` FOREIGN KEY (`category_id`) REFERENCES `l82_cli_cookie_scan_categories` (`id_cli_cookie_category`);
...
ALTER TABLE `l82_wc_download_log`
  ...
  ADD CONSTRAINT `fk_wp_wc_download_log_permission_id` FOREIGN KEY (`permission_id`) REFERENCES `l82_woocommerce_downloadable_product_permissions` (`permission_id`) ON DELETE CASCADE;
COMMIT;
